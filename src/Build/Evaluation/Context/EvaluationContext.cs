...
namespace Microsoft.Build.Evaluation.Context
{
    ...
    public class EvaluationContext
    {
        public enum SharingPolicy
        {
            ...
            /// <summary>
            /// Instructs the <see cref="EvaluationContext"/> to reuse SDK cache between the different project evaluations that use it.
        ...
        ///     The reasoning is that these values mean not reusing file system caches between evaluations,
        ...
        internal EvaluationContext ContextForNewProject()
        {
            ...
            switch (Policy)
            {
                ...
                case SharingPolicy.Isolated:
                    // Reuse the first not-fully-shared context if it has not seen an evaluation yet.
